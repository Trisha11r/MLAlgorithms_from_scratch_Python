...
def train(input_vec, labels, mode_val, epochs = 100, learn_rate =0.1):
	...
	if mode_val == "erm":
		...
		for i in range(10):
			...
			# fend_index = fstart_index + fold_size
			# fold.append(input_vec[fstart_index:fend_index])
			# fold_labels.append(labels[fstart_index:fend_index])
			# fstart_index+= fend_index
...
def main():
	...
	# Add the arguments
	my_argparse.add_argument('--dataset', type = str, help='dataset file')
	my_argparse.add_argument('--mode', type = str, help='ERM or ten fold')
	# Execute the parse_args() method
	args = my_argparse.parse_args()

	# file_path = "/Users/trishakanji/Documents/2nd Sem/ML/Assign1/linearly-separable-dataset.csv"
	...
	# train(train_input, labels, "erm", 100, 0.1)
